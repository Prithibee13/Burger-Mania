...
const Home = () => 
{
    ...
    return (
            ...
            <section className='home'>
                ...
                <div className="grid grid-cols-2 gap-10">
                    <div className='my-auto'>    
                        ...
                        <button className='border-2 border-transparent rounded-md'>Learn More</button>
                    </div>
                    <div>
        ...
        <button className='border-2 border-transparent rounded-md p-5' onClick={toReviewPage}>See More Reviews</button>
        </section>
        </div>
    );
};
